...
无头 CMS 与传统的 CMS 相比不同之处在于其将内容和展示分离，达到“前后端分离”的目的，这样可以和前端的技术栈解耦，增强扩展性。这里主要提供了各类内容的定义、管理、存储和分发等功能，其实就是管理着各类 DSL 数据，视为框架的基建部分。参照文件系统的设计，提供了文件夹和文件等基础的功能。并可自由的新增文件类型，让整个系统变得更自由，更易扩展。同时还提供了 Restful API 方便了各端可以自由的获取到托管的内容，也使得各接入端拥有了动态更新能力
...
- 框架迭代
  ...
  版本 1.0（2022 H1）：主要是提供低代码开发所需的基础的一些功能，将于上半年发布 1.0 版本
...
如果你想更深入的了解 Foxpage，可以移步至[项目文档](https://www.foxpage.io/#/)，同时推荐下面几篇文章供阅读：

1. Foxpage 在 Node 应用中的落地实践 [传送门](https://www.foxpage.io/#/blog/node-sdk/node-app)
2. Foxpage 低码下的组件化实践（一）[传送门](https://www.foxpage.io/#/blog/componentization)
3. Foxpage Node SDK 资源管理 [传送门](https://www.foxpage.io/#/blog/node-sdk/resource)
4. Foxpage Node SDK 插件化 [传送门](https://www.foxpage.io/#/blog/node-sdk/plugin)
